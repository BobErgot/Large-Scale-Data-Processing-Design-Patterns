...
public class PartitionPruningOutput extends Configured implements Tool {
  ...
  public static class RedisLastAccessOutputMapper extends Mapper<Object, Text, RedisKey, Text> {
    ...
    private final RedisKey outkey = new RedisKey();
  ...
  public static class RedisKey implements WritableComparable<RedisKey> {
    ...
    private final Text field = new Text();
  ...
  public static class RedisLastAccessOutputFormat extends OutputFormat<RedisKey, Text> {
    ...
    @Override
    public RecordWriter<RedisKey, Text> getRecordWriter(TaskAttemptContext job) throws IOException, InterruptedException {
    ...
    public static class RedisLastAccessRecordWriter extends RecordWriter<RedisKey, Text> {
      ...
      private final HashMap<Integer, Jedis> jedisMap = new HashMap<Integer, Jedis>();
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new PartitionPruningOutput(), args);
    System.exit(res);
  }
}
