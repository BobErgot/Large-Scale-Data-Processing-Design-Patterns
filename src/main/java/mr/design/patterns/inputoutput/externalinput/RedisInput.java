package mr.design.patterns.inputoutput.externalinput;
...
public class RedisInput extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    if (otherArgs.length != 3) {
      System.err.println("Usage: RedisInput <redis hosts> <output> <hash name>");
      System.exit(1);
    }
    ...
    job.setJarByClass(RedisInput.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new RedisInput(), args);
    System.exit(res);
  }
}
