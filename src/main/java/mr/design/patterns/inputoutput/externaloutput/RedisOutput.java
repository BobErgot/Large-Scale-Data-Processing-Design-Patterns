package mr.design.patterns.inputoutput.externaloutput;
...
public class RedisOutput extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setJarByClass(RedisOutput.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new RedisOutput(), args);
    System.exit(res);
  }
}
