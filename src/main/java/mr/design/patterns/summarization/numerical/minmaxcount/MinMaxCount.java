package mr.design.patterns.summarization.numerical.minmaxcount;
...
import mr.design.patterns.summarization.numerical.wordcount.CommentWordCount;
...
public class MinMaxCount extends Configured implements Tool {
  ...
  public static class MinMaxCountMapper extends Mapper<Object, Text, Text, MinMaxCountTuple> {
    ...
    public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
      ...
      if (creationDate == null || userId == null) {
        return;
      }
  ...
  public static class MinMaxCountReducer extends Reducer<Text, MinMaxCountTuple, Text, MinMaxCountTuple> {
    ...
    private final MinMaxCountTuple result = new MinMaxCountTuple();
  ...
  public int run(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "StackOverflow Comment MinMaxCount");
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new MinMaxCount(), args);
    System.exit(res);
  }
}
