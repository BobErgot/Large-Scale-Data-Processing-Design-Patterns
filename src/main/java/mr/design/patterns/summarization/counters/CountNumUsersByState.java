package mr.design.patterns.summarization.counters;

import mr.design.patterns.summarization.invertedindex.WikipediaExtractor;
...
public class CountNumUsersByState extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new CountNumUsersByState(), args);
		System.exit(res);
	}
}
